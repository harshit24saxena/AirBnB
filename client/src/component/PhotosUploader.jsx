        ...
        {addedPhoto.length > 0 &&
          addedPhoto.map((e, index) => (
            <div key={index} className="h-32 flex relative">
              ...
              />
              <button
                onClick={(ev) => removePhoto(e,ev)}
                className="absolute bottom-2 right-2 bg-black text-white py-2 px-3 bg-opacity-50 rounded-2xl cursor-pointer"
              >
                <svg
              ...
              <button
                onClick={(ev) => mainPhoto(e, ev)}
                className="absolute bottom-2 left-2 bg-black text-white py-2 px-3 bg-opacity-50 rounded-2xl cursor-pointer"
              >
                {e === addedPhoto[0] && (
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
